...
- **Variable Challenge XP:** Daily challenges now have configurable XP values (15, 20, or 25 XP) to reduce MVL race ties and add strategic variety. Each challenge stores its xpValue in the database (default 20). Admin panel includes XP selector dropdown when creating/editing challenges. Challenge cards and activity feed display the specific XP amount (+15 XP, +20 XP, or +25 XP). Challenge completion awards the custom xpValue instead of fixed amount (November 14, 2025).
